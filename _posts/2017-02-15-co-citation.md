...
You can zoom in if you want but the best way to make sense of it is to look at this <a href="{{ site.baseurl }}/assets/web6885/network6885.html" target="_blank">dynamic version</a>. To make it easier to read some of the sources, you can move the nodes around if you want.
